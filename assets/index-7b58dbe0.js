...
void main() {
    ...
    `},d=new Tn(u),f=new mt(new ri(2,2),d);f.position.z=-6,f.material.depthTest=!0,f.material.depthWrite=!1,i.add(f),window.addEventListener("resize",c);const g=new H_,_=new U0,m=new ch(13460997,20,6,1);t.current=m,m.shadow.mapSize.set(2048,2048),m.shadow.camera.near=.1,m.shadow.camera.far=5,m.castShadow=!0,m.shadow.bias=1e-7,m.position.set(0,.4,-.1),m.shadow.radius=25,i.add(m);function p(){const O=Math.random()*5+17.5,U=100,H=m.intensity,Y=performance.now();function G(J){const W=J-Y,ne=Math.min(W/U,1);m.intensity=H+(O-H)*ne,ne<1?requestAnimationFrame(G):setTimeout(p,100)}requestAnimationFrame(G)}p();const T=(()=>{const O=_.load("https://threejs.org/examples/textures/gradientMaps/threeTone.jpg");O.minFilter=pt,O.magFilter=pt;const U=_.load("https://threejs.org/examples/textures/gradientMaps/fiveTone.jpg");return U.minFilter=pt,U.magFilter=pt,{none:null,threeTone:O,fiveTone:U}})();g.load("sceneglb.glb",O=>{O.scene.traverse(U=>{if(U.isMesh&&(U.receiveShadow=!0,U.castShadow=!0,U.material)){const H=U.material;U.name.includes("Node")?U.material=new Ed({color:H.color,map:H.map,emissive:new ve(6710886),emissiveIntensity:.1,gradientMap:T.fiveTone}):(U.material=new sh({color:H.color,map:H.map,shininess:20,emissive:new ve(3355443),emissiveIntensity:.06,fog:!1}),U.name.includes("rockFlat")&&(U.receiveShadow=!1),H.aoMap&&(U.material.aoMap=H.aoMap,U.material.aoMapIntensity=1))}}),i.add(O.scene),a.shadowMap.needsUpdate=!0},O=>console.log(`Loading progress: ${O.loaded/O.total*100}%`),O=>console.error("An error occurred:",O));const S=new Wd(16777215,.5);i.add(S),V0(i);const M=new _c(i,200),R=new _c(i,200),w=new gc,A=new gc;w.colorA.set(1,.05,0),w.colorB.set(1,.71,.008),A.colorA.set(.08,.08,.08),A.colorB.set(.5,.5,.5),w.size=.3,A.size=.3,w.sizeVariation=.2,A.sizeVariation=.2,w.sizeFade=O=>Ii.lerp(.01/w.size,1,O),A.sizeFade=O=>Ii.lerp(1.5,.01,O),w.alphaFade=O=>O,A.alphaFade=O=>O,w.velocity.set(0,.5,0),A.velocity.set(0,.5,0),w.velocityVariation.set(0,1,0),A.velocityVariation.set(0,1,0),w.lifeTime=1,A.lifeTime=1,w.particleForce.set(0,.2,0),A.particleForce.set(0,.6,0),w.particleEmitter=new ao(new mt(new _r(.2,.2))),A.particleEmitter=new ao(new mt(new _r(.2,.2))),w.particleEmitter.shape.position.set(.02,.4,-.12),A.particleEmitter.shape.position.set(-.03,.45,-.17);const P=new mt(new To(.5,32,32),new Un({color:16711680,wireframe:!0,visible:!1}));P.position.set(0,5,0),i.add(P);let E=performance.now();const v=()=>{n=requestAnimationFrame(v),o.begin();const O=performance.now(),U=(O-E)*.001;E=O,d.uniforms.iTime.value=O*.001,d.uniforms.iResolution.value.set(window.innerWidth,window.innerHeight,1),h.setFromCamera(l,r);const H=h.intersectObjects(i.children,!0).filter(Y=>Y.distance>2);H.length?P.position.copy(H[0].point):P.position.set(10,10,5),a.autoClear=!1,a.clear(),a.render(i,r),M.emit(w),R.emit(A),xc(P,M.particles,U),xc(P,R.particles,U),M.update(U),R.update(U),o.end()};return v(),()=>{cancelAnimationFrame(n),a.dispose(),s.current&&s.current.removeChild(a.domElement)}},si={paddingX:"sm:px-16 px-6",paddingY:"sm:py-16 py-6",padding:"sm:px-16 px-6 sm:py-16 py-10",heroHeadText:"font-black text-white lg:text-[60px] sm:text-[40px] xs:text-[30px] text-[30px] lg:leading-[68px] mt-2",sectionHeadText:"text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]",sectionSubText:"sm:text-[18px] text-[14px] text-secondary uppercase tracking-wider",titleHeadText:"font-black text-white lg:text-[60px] sm:text-[40px] xs:text-[30px] text-[30px] lg:leading-[68px] mt-2 text-[#00CCFF] font-display ease-out duration-500 neon-text-blue font-normal"},W0=({transition:s,onSky:e,onHome:t,value:n})=>{const i=ut.useRef(null),r=ut.useRef(null),a=ut.useRef(null),o=ut.useRef(null),c=l=>l<.5?2*l*l:-1+(4-2*l)*l;return ut.useEffect(()=>{const l=G0(i,r,a);return()=>{l&&l(),o.current&&cancelAnimationFrame(o.current)}},[]),ut.useEffect(()=>{if(r.current){const l=e?{x:.3,y:2,z:4}:{x:2.8,y:.9,z:1.5};let h=e?{x:-.2,y:.05,z:0}:{x:0,y:1.078,z:0};h.x=t?h.x:.42;const u=1e3,d=performance.now(),f={x:r.current.position.x,y:r.current.position.y,z:r.current.position.z},g={x:r.current.rotation.x,y:r.current.rotation.y,z:r.current.rotation.z},_=m=>{const p=m-d;let T=Math.min(p/u,1);const S=c(T);r.current.position.x=f.x+(l.x-f.x)*S,r.current.position.y=f.y+(l.y-f.y)*S,r.current.position.z=f.z+(l.z-f.z)*S,r.current.rotation.x=g.x+(h.x-g.x)*S,r.current.rotation.y=g.y+(h.y-g.y)*S,r.current.rotation.z=g.z+(h.z-g.z)*S,T<1&&(o.current=requestAnimationFrame(_))};o.current=requestAnimationFrame(_)}},[e,t]),we("div",{className:"h-screen w-full mx-auto relative",children:[B("div",{ref:i,className:"h-screen w-full"}),B("div",{className:`absolute top-[10%] left-[10%] max-w-7xl flex flex-row items-start gap-5 transition-transform duration-400 ${s?"transform -translate-x-full":"transform translate-x-0"}`,children:we("h1",{className:`${s?"text-transparent":si.heroHeadText}`,children:["Welcome to ",B("br",{}),B("span",{className:`${s?"text-transparent":si.titleHeadText}`,children:"3D Game Engines"})]})})]})},X0=({transition:s,onSky:e,onHome:t,value:n})=>we("section",{className:"relative w-full h-screen mx-auto",children:[B(W0,{transition:s,onSky:e,onHome:t,value:n}),B("div",{className:"absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center",children:B("a",{href:"",children:B("div",{className:"w-[36px] h-[64px] rounded-3xl border-4 border-[#00ccff] flex justify-center items-start p-2",children:B("div",{className:"w-3 h-3 rounded-full bg-[#00ccff] mb-1",style:{animation:"float 1.5s infinite ease-in-out"}})})})})]}),vc=[{id:"home",title:"Home",path:"/Website/"},{id:"classes",title:"Classes",path:"/Website/"},{id:"assignments",title:"Assignments",path:"/Website/"},{id:"labs",title:"Labs",path:"/Website/"},{id:"resources",title:"Resources",path:"/Website/"}],q0="/Website/assets/menu-b5599218.svg",Y0="/Website/assets/close-54702a70.svg",j0=({onOverlaySelect:s,setAudio:e,audio:t})=>{const[n,i]=ut.useState("Home"),[r,a]=ut.useState(!1),[o,c]=ut.useState(!1);return ut.useEffect(()=>{const l=()=>{window.scrollY>100?c(!0):c(!1)};return window.addEventListener("scroll",l),()=>window.removeEventListener("scroll",l)},[]),B("nav",{className:`${si.paddingX} w-full flex items-center py-5 fixed top-0 z-20 ${o?"bg-primary":"bg-transparent"}`,children:we("div",{className:"w-full flex justify-between items-center max-w-7xl mx-auto",children:[B("div",{className:"flex items-center gap-2",onClick:()=>{i(""),window.scrollTo(0,0)},children:we("p",{className:"text-white text-[18px] font-bold cursor-pointer flex ",children:["CS1950U ",B("span",{className:"sm:block hidden",children:"   |   3D Game Engines"})]})}),we("svg",{xmlns:"http://www.w3.org/2000/svg",width:"30",height:"30",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:`cursor-pointer ${t?"text-[#00CCFF]":"text-white"}`,onClick:()=>e(!t),children:[B("path",{d:"M2 10v3"}),B("path",{d:"M6 6v11"}),B("path",{d:"M10 3v18"}),B("path",{d:"M14 8v7"}),B("path",{d:"M18 5v13"}),B("path",{d:"M22 10v3"})]}),B("ul",{className:"list-none hidden sm:flex flex-row gap-10",children:vc.map(l=>B("li",{className:`${n===l.title?"text-[#00ccff] font-display ease-out duration-200 neon-text-blue font-normal":"text-white"} hover:text-[#53ddff] text-[18px] font-medium cursor-pointer`,onClick:()=>{i(l.title),s(l.title)},children:B("div",{children:l.title})},l.id))}),we("div",{className:"sm:hidden flex flex-1 justify-end items-center",children:[B("img",{src:r?Y0:q0,alt:"menu",className:"w-[28px] h-[28px] object-contain",onClick:()=>a(!r)}),B("div",{className:`${r?"flex":"hidden"} p-6 bg-black absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`,children:B("ul",{className:"list-none flex justify-end items-start flex-1 flex-col gap-4",children:vc.map(l=>B("li",{className:`font-poppins font-medium cursor-pointer text-[16px] ${n===l.title?"text-[#00ccff]":"text-white"}`,onClick:()=>{a(!r),i(l.title),s(l.title)},children:B("div",{children:l.title})},l.id))})})]})]})})},K0=({showAbout:s,onSky:e,onHome:t})=>(e(!1),t(!0),we("div",{className:` absolute top-0 left-0 w-1/2 h-screen z-1 no-scrollbar transition-transform duration-400 ${s?"transform translate-x-0":"transform -translate-x-full"}`,children:[B("div",{className:"absolute top-0 left-0 w-full h-screen no-scrollbar z-0",style:{backgroundColor:"rgba(0, 0, 0, 0.9)",maskImage:"linear-gradient(to left, transparent, rgba(0, 0, 0, 0.4) 15%, rgba(0, 0, 0, 0.6) 30%, black 100%)",WebkitMaskImage:"linear-gradient(to left, transparent, rgba(0, 0, 0, 0.4) 15%, rgba(0, 0, 0, 0.6) 30%, black 100%)"}}),B("div",{className:" mx-20 relative overflow-y-auto no-scrollbar h-full z-10",children:we("section",{id:"About",className:"mt-[20%] mb-[20%] flex flex-col gap-10 no-scrollbar z-20",children:[B("h2",{className:"text-3xl font-semibold md:text-5xl text-[#00ccff]",children:"🔮 3D Game Engines 🔮"}),we("div",{className:"flex flex-col gap-10 md:flex-row",children:[we("div",{className:"flex flex-col gap-6",children:[B("p",{children:"CSCI1950U functions like a group independent study where each student will implement their own 3D game engine in C++. Topics covered include engine architecture and design, collision systems, AI systems, and independently chosen topics implemented in a final project such as networking, particles, animation, or rigidbody physics."}),B("p",{children:"Class time will be used to review the material and to work on projects with help from the TAs, so make sure to bring your laptops to class!"})]}),we("div",{className:"flex flex-row justify-between md:flex-shrink-0 md:flex-col",children:[we("div",{className:"flex flex-1 flex-col gap-1",children:[we("div",{className:"flex flex-col",children:[B("strong",{className:"font-semibold text-[#00ccff]",children:"Course:"}),B("a",{target:"_blank",rel:"noopener noreferrer",className:"underline",href:"https://www.coursicle.com/brown/courses/CSCI/1950U/",children:"CSCI 1950U"})]}),we("div",{className:"flex flex-col",children:[B("strong",{className:"font-semibold text-[#00ccff]",children:"Professor:"}),B("a",{target:"_blank",rel:"noopener noreferrer",className:"underline",href:"https://cs.brown.edu/people/faculty/dritchi1/",children:"Daniel Ritchie"})]}),we("div",{className:"flex flex-col",children:[B("strong",{className:"font-semibold text-[#00ccff]",children:"Location:"}),we("a",{target:"_blank",rel:"noopener noreferrer",className:"underline",href:"https://maps.app.goo.gl/1xfqYMQZHMA6Jadg9",children:["CIT Center ",B("br",{})," 506"]})]}),we("div",{className:"flex flex-col",children:[B("strong",{className:"font-semibold text-[#00ccff]",children:"Time:"}),"W 3pm-5:30pm"]})]}),B("hr",{className:"my-2 border-t-2 border-[#00ccff]"}),we("div",{className:"flex flex-1 flex-col gap-1",children:[B("a",{target:"_blank",rel:"noopener noreferrer",className:"underline",href:"https://docs.google.com/document/d/1KhLl0Mn_lbT0RRP9Wl5N4IUS85fMoUC0QG67S4wkZ5k/edit?usp=sharing",children:"Syllabus"}),B("a",{target:"_blank",rel:"noopener noreferrer",className:"underline",href:"https://join.slack.com/share/enQtODMzOTY0MTgyOTI2NC1jNzAxODI4MGM3OWI0ODc0MzY4MGIxOTgxODJjZDMxNDRmMzZlOGRmYjk0NTQ4ZjhhOWI5OGVkZDQzZmJiZDE4?_gl=1*141lihu*_gcl_au*MTQyNTc0MTg4My4xNzMyNTg1NzMy",children:"Slack"})]})]})]}),we("h2",{className:"text-3xl font-semibold md:text-5xl text-[#ffffff]",children:["PAX East Form ",B("a",{target:"_blank",rel:"noopener noreferrer",className:"underline text-[#00ccff]",href:"https://forms.gle/385PucHrZUDPL1kk6",children:"HERE"})]}),B("h4",{className:"text-3xl font-semibold md:text-3xl text-[#00ccff]",children:"Hours"}),B("div",{className:" flex justify-center items-center",children:B("iframe",{src:"https://calendar.google.com/calendar/embed?src=c_59db87f33e0fef48a0c38c789cb97a8687472d305887dc36092b45f82b95375a%40group.calendar.google.com&ctz=America%2FNew_York",style:{width:"130vh",height:"100vh",maxHeight:"400px",borderRadius:"10px"},title:"Google Calendar"})}),B("h4",{className:"text-3xl font-semibold md:text-3xl text-[#00ccff]",children:"Staff"}),we("div",{children:[we("div",{children:[B("b",{className:"font-semibold",children:"Professor: "}),B("a",{target:"_blank",href:"mailto:daniel_ritchie@brown.edu",children:" daniel_ritchie@brown.edu"})]}),we("div",{children:[B("b",{className:"font-semibold",children:"Professor and HTAs:"}),B("a",{target:"_blank",href:"mailto:cs1950uheadtas@lists.brown.edu",children:" cs1950uheadtas@lists.brown.edu"})]}),B("div",{className:"italic",children:"Do not email sensitive information, including Health Services & Dean's Notes, to any HTAs, UTAs, or STAs."})]}),we("div",{className:"xs:grid-cols-2 grid w-full grid-cols-1 gap-4 md:grid-cols-2",children:[we("div",{className:"flex flex-col gap-2 p-16 pb-0",children:[B("h3",{className:"text-2xl font-medium",children:"Professor"}),we("div",{className:"frosted flex flex-col rounded-lg bg-[#00ccff]",children:[B("img",{className:"aspect-square w-full rounded-t-lg object-contain",src:"/Website/Daniel_Ritchie.jpg",alt:"Daniel Ritchie"}),we("div",{className:"p-4",children:[B("div",{className:"text-md font-medium",children:"Daniel Ritchie"}),B("div",{className:"text-sm font-semibold text-slate-600",children:"dritchi • he/him"}),B("div",{className:"mt-2 text-sm italic text-white",children:"Has an Erdős number of 4, a Bacon number of 3, and (debatably) an Erdős-Bacon number of 7."})]})]})]}),we("div",{className:"flex flex-col gap-2 p-16 pb-0",children:[B("h3",{className:"text-2xl font-medium",children:"Head TA"}),we("div",{className:"frosted flex flex-col rounded-lg bg-[#00ccff]",children:[B("img",{className:"aspect-square w-full rounded-t-lg object-contain",src:"/Website/Arman.jpg",alt:"Arman Mohammadi"}),we("div",{className:"p-4",children:[B("div",{className:"text-md font-medium",children:"Arman Mohammadi"}),B("div",{className:"text-sm font-semibold text-slate-600",children:"amoham42 • he/him"}),B("div",{className:"mt-2 text-sm text-white",children:"I love camping, hiking, and playing video games. I'm excited to be a TA for this course!"})]})]})]})]}),B("div",{className:"xs:grid-cols-2 grid w-full grid-cols-1 gap-4 md:grid-cols-2",children:we("div",{className:"flex flex-col gap-2 p-16 pb-0",children:[B("h3",{className:"text-2xl font-medium",children:"Head TA"}),we("div",{className:"frosted flex flex-col rounded-lg bg-[#00ccff]",children:[B("img",{className:"aspect-square w-full rounded-t-lg object-contain",src:"/Website/Feiyue.jpeg",alt:"Feiyue Zhang"}),we("div",{className:"p-4",children:[B("div",{className:"text-md font-medium",children:"Feiyue Zhang"}),B("div",{className:"text-sm font-semibold text-slate-600",children:"fzhang50 • he/him"}),B("div",{className:"mt-2 text-sm italic text-white",children:"Games are fun."})]})]})]})})]})})]})),Io=({data:s,lectures:e=!1,projects:t=!1,labs:n=!1})=>{const i="pb-3 text-[#00CCFF] font-display ease-out duration-500 neon-text-blue font-bold";return we("table",{className:"w-full mx-auto",children:[B("thead",{style:{borderBottom:"2px solid",color:"#FFFFFF"},children:B("tr",{className:"table-header",children:t?we(Gn,{children:[B("th",{className:`text-left ${i}`,children:"Project"}),B("th",{className:`px-5 text-left ${i}`,children:"Checkpoint"}),B("th",{className:`text-right ${i}`,children:"Date Due"}),B("th",{className:`text-right ${i}`,children:"Link"})]}):n?we(Gn,{children:[B("th",{className:`text-left ${i}`,children:"Topic"}),B("th",{className:`px-5 text-right ${i}`,children:"Date"}),B("th",{className:`text-right ${i}`,children:"Handout"}),B("th",{className:`text-right ${i}`,children:"Submission"})]}):we(Gn,{children:[B("th",{className:`text-left ${i}`,children:"Topic"}),B("th",{className:`px-5 text-right ${i}`,children:"Date"}),B("th",{className:`text-right ${i}`,children:"Google Slides"}),B("th",{className:`text-right ${i}`,children:"Code Demos"})]})})}),B("tbody",{children:s.map((r,a)=>B("tr",{children:t?we(Gn,{children:[B("td",{className:"py-3 text-left",children:r.project}),B("td",{className:"px-5 text-left",children:r.checkpoint}),B("td",{className:"px-5 text-right",children:r.dateDue}),B("td",{className:"text-right",children:r.link?B("a",{className:"hover-glow focus:underline",target:"_blank",rel:"noopener noreferrer",href:r.link,style:{color:"#00CCFF",fontWeight:"bold"},children:"Link"}):"-"})]}):n?we(Gn,{children:[B("td",{className:"py-3 text-left",children:r.topic}),B("td",{className:"px-5 text-right",children:r.date}),B("td",{className:"text-right",children:r.slides?B("a",{className:"hover-glow focus:underline",target:"_blank",rel:"noopener noreferrer",href:r.slides,style:{color:"#00CCFF",fontWeight:"bold"},children:"Handout"}):"-"}),B("td",{className:"text-right",children:r.submission_folder?B("a",{className:"hover-glow focus:underline",target:"_blank",rel:"noopener noreferrer",href:r.submission_folder,style:{color:"#00CCFF",fontWeight:"bold"},children:"Submission"}):"-"})]}):we(Gn,{children:[B("td",{className:"py-3 text-left",children:r.topic}),B("td",{className:"px-5 text-right",children:r.date}),B("td",{className:"text-right",children:r.googleSlides?B("a",{className:"hover-glow focus:underline",target:"_blank",rel:"noopener noreferrer",href:r.googleSlides,style:{color:"#00CCFF",fontWeight:"bold"},children:"Slides"}):"-"}),B("td",{className:"text-right",children:r.codeDemos?B("a",{className:"hover-glow focus:underline",target:"_blank",rel:"noopener noreferrer",href:r.codeDemos,style:{color:"#00CCFF",fontWeight:"bold"},children:"Demo"}):"-"}),e?B(Gn,{}):B("td",{className:"text-right",children:r.worksheets?B("a",{className:"hover-glow focus:underline",target:"_blank",rel:"noopener noreferrer",href:r.worksheets,style:{color:"#00CCFF",fontWeight:"bold"},children:"Worksheet"}):"-"})]})},a))})]})},$0=[{date:"1/22",class:"1",topic:"Course Intro, Basic Engine Architecture, Camera and Game Loops",googleSlides:"https://docs.google.com/presentation/d/1XUIzK4t-KBSompqcti0fThZbQcvcsJvEHcBUbK9KWeQ/edit?usp=sharing",codeDemos:""},{date:"1/29",class:"2",topic:"Applications and Screens",googleSlides:"",codeDemos:""},{date:"2/5",class:"3",topic:"Game Worlds, Entity Component System, Collisions Intro",googleSlides:"",codeDemos:""},{date:"2/12",class:"4",topic:"Sphere/AAB/Cylinder Collisions, Ellipsoid/Triangle Collisions",googleSlides:"",codeDemos:""},{date:"2/26",class:"5",topic:"GJK, EPA, and MPR Algorithms",googleSlides:"",codeDemos:""},{date:"3/5",class:"",topic:"No Lecture - Extra Hours Instead",googleSlides:"",codeDemos:""},{date:"3/12",class:"6",topic:"Spatial Acceleration Data Structures",googleSlides:"",codeDemos:""},{date:"3/19",class:"8",topic:"AI and Pathfinding",googleSlides:"",codeDemos:""},{date:"3/26",class:"9",topic:"🌷 Spring Break - No Class 🌷",googleSlides:"",codeDemos:""},{date:"4/2",class:"",topic:"Platformer 3 Check-In",googleSlides:"",codeDemos:""},{date:"4/9",class:"10",topic:"Final Project Topics",googleSlides:"",codeDemos:""},{date:"4/16",class:"11",topic:"Final Project Check-In 1",googleSlides:"",codeDemos:""},{date:"4/23",class:"12",topic:"👽 Q&A with Mobius Digital 👽",googleSlides:"",codeDemos:""},{date:"4/30",class:"13",topic:"Final Project Check-In 2",googleSlides:"",codeDemos:""},{date:"5/7",class:"14",topic:"Final Project Presentations at 5 PM",googleSlides:"",codeDemos:""}],Z0=({onChange:s,onSky:e,onHome:t})=>(s(!0),e(!0),t(!1),B("div",{className:" absolute top-0 left-0 h-screen w-screen z-0 no-scrollbar transition-transform duration-400",children:B("div",{className:" mx-[20%] relative overflow-y-auto no-scrollbar h-full z-10",children:we("section",{className:"mt-[10%] mb-[10%] flex flex-col gap-10 no-scrollbar z-20",children:[B("div",{children:B("h2",{className:si.titleHeadText,children:"Classes"})}),B("p",{children:"Classes will meet in person in CIT room 506. We recommend taking a look at the code demos accompanying each lecture to see how to implement C++ tips. For some lectures, there are accompanying worksheets to aid in more math heavy topics."}),B("div",{className:" flex flex-wrap gap-10",children:B(Io,{data:$0,lectures:!0})})]})})})),J0=[{topic:"Introduction",date:"1/22",slides:"https://docs.google.com/document/d/1cigrsK6drWl8M2O_rTFhiCyhYoMLyjwlxzKg5OntW0c/edit?usp=drive_link",submission_folder:"https://drive.google.com/drive/folders/15EDPu6M0YSm1cX7XAQ0uLScfGDJK_ElN?usp=drive_link"},{topic:"Lab 2",date:"1/29",slides:"",submission_folder:""},{topic:"Lab 3",date:"2/5",slides:"",submission_folder:""},{topic:"Lab 4",date:"2/26",slides:"",submission_folder:""},{topic:"Lab 5",date:"3/12",slides:"",submission_folder:""},{topic:"Lab 6",date:"4/2",slides:"",submission_folder:""}],Q0=({onChange:s,onSky:e,onHome:t})=>(s(!0),e(!0),t(!1),B("div",{className:" absolute top-0 left-0 h-screen w-screen z-0 no-scrollbar transition-transform duration-400",children:B("div",{className:" mx-[20%] relative overflow-y-auto no-scrollbar h-full z-10",children:we("section",{className:"mt-[10%] mb-[10%] flex flex-col gap-10 no-scrollbar z-20",children:[B("div",{children:B("h2",{className:si.titleHeadText,children:"Labs"})}),B("p",{className:"mt-10",children:"There are 6 labs in total in this class. Each will take 2-3 hours to complete."}),B("div",{className:"mt-10 flex flex-wrap gap-10",children:B(Io,{data:J0,labs:!0})})]})})})),ex=[{title:"Forms",links:[{href:"https://forms.gle/srYNPvRaBaquZ2pR9",label:"Collaboration Policy Form"},{href:"https://forms.gle/NCN64bBJXG5Ycs3x8",label:"Anonymous Feedback Form"},{href:"https://forms.gle/zV5vphiDysmAMHnx8",label:"Lab Feedback Form"}]},{title:"Guides and Tutorials",links:[{href:"https://hackmd.io/gGOpcqoeTx-BOvLXQWRgQg",label:"GitHub Guide"},{href:"https://hackmd.io/@BrownDeepLearningS24/BkIT3sW6s",label:"Google Colaboratory Tutorial"},{href:"https://google.github.io/styleguide/cppguide.html",label:"Google C++ Style Guide"}]},{title:"Department Resources",links:[{href:"https://cs.brown.edu/degrees/undergrad/concentrating-in-cs/concentration-requirements-2020/capstone/",label:"Capstone Information"},{href:"https://cheatography.com/davechild/cheat-sheets/linux-command-line/",label:"Linux Cheat Sheet"},{href:"http://cs.brown.edu/about/system/accounts/email/",label:"Setting Up Email"},{href:"https://ithelp.brown.edu/",label:"IT Services"},{href:"https://ithelp.brown.edu/kb/articles/it-service-center-loaner-equipment-3",label:"IT Loaner Laptops"}]},{title:"Organizations",links:[{href:"https://www.brown.edu/campus-life/support/counseling-and-psychological-services/",label:"CAPS"},{href:"https://cs.brown.edu/people/orgs/wics/",label:"Women in Computer Science"},{href:"https://mosaicplus.github.io/",label:"Mosaic+"},{href:"https://www.brown.edu/about/administration/title-ix/",label:"Title IX"},{href:"https://cs.brown.edu/about/diversity/health-wellness-student-advocates/",label:"Health and Wellness Advocates"},{href:"https://cs.brown.edu/about/diversity/student-advocates-diversity-and-inclusion/",label:"Diversity and Inclusion"},{href:"http://cs.brown.edu/people/orgs/dug/",label:"CS DUG"}]},{title:"Collisions and Optimizations",links:[{href:"https://pbr-book.org/3ed-2018/Primitives_and_Intersection_Acceleration/Bounding_Volume_Hierarchies",label:"Bounding Volume Hierarchies"},{href:"https://peroxide.dk/papers/collision/collision.pdf",label:"Ellipsoid-Triangle Collisions"},{href:"https://www.youtube.com/watch?v=MDusDn8oTSE",label:"GJK Algorithm Explanation & Implementation (Winterdev)"},{href:"https://www.youtube.com/watch?v=0XQ2FSz3EK8",label:"EPA Explanation & Implementation (Winterdev)"},{href:"https://www.youtube.com/watch?v=ajv46BSqcK4",label:"A Strange But Elegant Approach to a Surprisingly Hard Problem (GJK Algorithm)"}]},{title:"Suggested Extra Material",links:[{href:"https://www.youtube.com/user/ExtraCreditz",label:"Extra Credits YouTube Channel"},{href:"http://allenchou.net/game-physics-series",label:"Video Game Physics"},{href:"http://fgiesen.wordpress.com/2011/07/09/a-trip-through-the-graphics-pipeline-2011-index/",label:"Graphics Pipeline 2011"},{href:"http://gafferongames.com/networking-for-game-programmers/",label:"Networking for Game Programmers"},{href:"http://gafferongames.com/networked-physics/introduction-to-networked-physics/",label:"Networking for Physics Programmers"}]},{title:"Useful Libraries",links:[{href:"http://www.jenkinssoftware.com/",label:"RakNet: Networking Engine"},{href:"http://icculus.org/manymouse/",label:"ManyMouse: Multiple Mouse Input"},{href:"http://code.google.com/p/recastnavigation/",label:"Recast and Detour: Pathfinding"}]},{title:"Engine Architecture",links:[{href:"https://gpfault.net/posts/mapping-types-to-values.txt.html",label:"C++ TypeMaps"}]}],tx=({onChange:s,onSky:e,onHome:t})=>(s(!0),e(!0),t(!1),B("div",{className:"absolute top-0 left-0 h-screen w-screenno-scrollbar transition-transform duration-400",children:B("div",{className:" mx-[20%] relative overflow-y-auto no-scrollbar h-full",children:B("section",{className:"mt-[10%] mb-[10%]",children:we("section",{id:"resources",children:[B("div",{children:B("h2",{className:si.titleHeadText,children:"Resources"})}),B("div",{className:"flex flex-wrap gap-4",children:ex.map((n,i)=>we("div",{children:[B("h3",{className:"mt-5 text-2xl ease-out duration-500 neon-text-blue font-normal",children:n.title}),B("hr",{className:"mb-2 border-slate-600"}),B("div",{className:"flex flex-col gap-1",children:n.links.map((r,a)=>B("a",{className:"w-fit mr-10 text-lg",href:r.href,children:r.label},a))})]},i))}),we("div",{children:[B("h3",{className:"mt-5 text-2xl font-display ease-out duration-500 neon-text-blue font-normal",children:"Previous Projects"}),B("hr",{className:"mb-2 border-slate-600"}),B("iframe",{width:"100%",height:"600",src:"//www.youtube.com/embed/34tPeh4s24E",frameborder:"0",allowfullscreen:""})]})]})})})})),nx=[{project:"Warmup",checkpoint:"Setup Tutorial",dateDue:"1/29",link:"https://docs.google.com/document/d/1AdLyNCNdti5uyhQ1szP7_cxAqbyKiq0nLrRWKU4Ihc4/edit?usp=sharing"},{project:"Warmup 1",checkpoint:"Basic Engine Architecture",dateDue:"2/5",link:""},{project:"Warmup 2",checkpoint:"Gameworld, ECS, Systems",dateDue:"2/26",link:""},{project:"Platformer",checkpoint:"Platformer 1 (Collisions)",dateDue:"3/12",link:""},{project:"Platformer 2",checkpoint:"Optimizations",dateDue:"4/2",link:""},{project:"Platformer 3",checkpoint:"Pathfinding, AI",dateDue:"4/16",link:""},{project:"Final",checkpoint:"Game",dateDue:"5/6",link:""},{project:"Presentation",checkpoint:"",dateDue:"5/7",link:""}],ix=({onChange:s,onSky:e,onHome:t})=>(s(!0),e(!0),t(!1),B("div",{className:"absolute top-0 left-0 h-screen w-screen z-0 no-scrollbar",children:B("div",{className:" mx-[20%] relative overflow-y-auto no-scrollbar h-full z-10",children:we("section",{className:"mt-[10%] mb-[10%] flex flex-col no-scrollbar z-20",children:[B("div",{className:"mb-5",children:B("h2",{className:si.titleHeadText,children:"Assignments"})}),B("p",{children:"All assignments (except for the final) are due at 3pm of the day listed and will be checked for completion in person. "}),B("br",{}),B("p",{children:"The link to sign up for times is here. The final is due on Friday, May 6 at 9am."}),B("br",{}),we("p",{children:[" The stencil code template can be found ",B("a",{target:"_blank",rel:"noopener noreferrer",className:"underline text-[#00ccff]",href:"https://classroom.github.com/a/2rC8PxkO",children:" Here"})," "]}),B("div",{className:"mt-5 flex flex-wrap gap-5",children:B(Io,{data:nx,projects:!0})})]})})})),sx=()=>{const[s,e]=ut.useState(-1),[t,n]=ut.useState(!1),[i,r]=ut.useState(!1),[a,o]=ut.useState(!1),[c,l]=ut.useState(!0),[h,u]=ut.useState(0),[d,f]=ut.useState(!1),g=ut.useState(new Audio("/Website/fire.mp3"))[0],[_,m]=ut.useState("Home"),p=A=>{m(A)},T=A=>{r(A)},S=A=>{o(A)},M=A=>{l(A)},R=A=>{if(f(A),A)g.loop=!0,g.play().then(()=>f(!0)).catch(P=>console.error("Audio playback failed",P));else if(!A)try{g.loop=!1,g.pause(),f(!1)}catch(P){console.error("Audio pause failed!",P)}},w=A=>{e(P=>{const E=P+(A.deltaY>0?1:-1),v=Math.min(15,Math.max(E,-5));return v<0?(n(!1),r(!1)):(n(!0),r(!0)),u(v),v})};return ut.useEffect(()=>(window.addEventListener("wheel",w),()=>{window.removeEventListener("wheel",w)}),[]),B("div",{children:we("div",{className:"relative z-0 bg-primary",children:[B(j0,{onOverlaySelect:p,setAudio:R,audio:d}),B("div",{className:"relative h-screen",children:B(X0,{transition:i,onSky:a,onHome:c,value:h})}),_==="Home"&&B(K0,{showAbout:t,onSky:S,onHome:M}),_==="Classes"&&B(Z0,{onChange:T,onSky:S,onHome:M}),_==="Assignments"&&B(ix,{onChange:T,onSky:S,onHome:M}),_==="Resources"&&B(tx,{onChange:T,onSky:S,onHome:M}),_==="Labs"&&B(Q0,{onChange:T,onSky:S,onHome:M})]})})};fa.createRoot(document.getElementById("root")).render(B(Ph.StrictMode,{children:B(sx,{})}));
